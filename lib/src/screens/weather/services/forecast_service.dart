...
import 'package:katai/src/screens/weather/constants/constants.dart';
...
void getForecastList(String city, String qtyDays, BuildContext context) async {
  final dio = Dio();
  final String url ='$weather_map_base_url/$forecastEndpoint?q=$city&days=$qtyDays&key=$weather_api_key';
